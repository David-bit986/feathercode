...
export const DEFAULT_THEME_ID = "feather-default";
...
const STORE_PATH = "fc-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "fc://prefs-changed";
...
const KEYS_CHANGED_EVENT = "fc://ai-keys-changed";
